...
const phases = [
  ...
  },
  {
    ...
    description: "Mit 6,5–11,0 MWp Gesamtleistung wird Steuerbarkeit zum entscheidenden Faktor. Ein 3–6 MWh BESS mit intelligentem EMS verwandelt die verteilte Erzeugung in ein steuerbares Gesamtsystem. Peak Shaving senkt den Leistungspreis, Spotmarkt-Strategien optimieren den Winterbezug.",
    results: [
      "BESS 3–6 MWh in Betrieb (C-Rate optimiert für Industrie-Lastprofil)",
    ...
    kpis: [
      { label: "BESS-Kapazität", value: "3–6 MWh" },
      { label: "Peak Shaving", value: "10–15 %" },
      { label: "Eigenverbrauch", value: ">80 %" },
      { label: "Steuerung", value: "Echtzeit-EMS" },
    ],
    investment: [
      { label: "BESS 3–6 MWh (150–200 €/kWh)", range: "450 T€–1,2 Mio €" },
      { label: "EMS & standortweite Integration", range: "120–250 T€" },
    ],
    investTotal: "600 T€–1,5 Mio €",
  ...
  },
  {
    ...
    systemKpis: [
      ...
      { label: "Eigenverbrauch", value: ">80 %", sub: "Mit 3–6 MWh BESS-Optimierung" },
    ...
    investmentSummary: [
      ...
      { phase: "III", label: "Speicher & Steuerung", range: "600 T€–1,5 Mio €", roi: "10–15 % Peak Shaving", maxMio: 1.5, score: 65 },

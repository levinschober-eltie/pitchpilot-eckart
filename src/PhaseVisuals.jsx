  ...
  return (
    <defs>
      ...
      <linearGradient id="skyGrad" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor={cool ? "#050E1C" : warm ? "#18182E" : C.skyTop} />
        <stop offset="40%" stopColor={cool ? "#0C1828" : warm ? "#1C1E3C" : C.skyMid} />
      ...
      <linearGradient id="hillGrad" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor={C.forestDark} stopOpacity="0.65" />
      ...
      <marker id="arrW" markerWidth="5" markerHeight="4" refX="4" refY="2" orient="auto">
        <path d="M0,0 L5,2 L0,4" fill={C.warmOrangeLight} opacity="0.5" />
      </marker>
    ...
    <g>
      ...
      {cool && (
        <g>
          ...
          <circle cx="49" cy="36" r="5.5" fill={C.skyTop} opacity="0.06" />
          {/* Crater details */}
      ...
      {[[55,78],[60,82],[65,79],[310,64],[315,68],[320,65],[362,60],[366,63]].map(([x,y],i) => (
        <circle key={`vl${i}`} cx={x} cy={y} r="0.5" fill={C.goldLight} opacity="0.06">
...
function Pine({ x, y, h = 8, opacity: op = 0.7 }) {
  return (
    <g opacity={op}>
      ...
      <path d={`M${x},${y - h * 0.75} L${x - h * 0.45},${y - h * 0.05} L${x + h * 0.45},${y - h * 0.05} Z`} fill={C.forestMid} />
      <path d={`M${x},${y - h} L${x - h * 0.32},${y - h * 0.2} L${x + h * 0.32},${y - h * 0.2} Z`} fill={C.forest} />
...
function StreetLamp({ x, y }) {
  return (
    <g opacity="0.38">
      ...
      <circle cx={x} cy={y - 10} r="1.3" fill={C.goldLight} opacity="0.25">
    ...
    <g opacity={op}>
      ...
      {solar && (
        <g>
          ...
          <circle cx={x + w * 0.3} cy={y - d * 0.2} r="2" fill={C.goldLight} opacity="0">
...
function WaterTower({ x, y }) {
  return (
    <g opacity="0.22">
      ...
      {/* Tank */}
      <ellipse cx={x} cy={y-4} rx="6" ry="2" fill={C.navyMid} stroke="rgba(255,255,255,0.08)" strokeWidth="0.4" />
      <rect x={x-6} y={y-10} width="12" height="7" fill={C.navyMid} stroke="rgba(255,255,255,0.07)" strokeWidth="0.4" />
      <ellipse cx={x} cy={y-10} rx="6" ry="2" fill={C.navyLight} stroke="rgba(255,255,255,0.08)" strokeWidth="0.4" />
    </g>
  );
}

/* ── Electric substation box ─────────────────────────────────── */
function SubStation({ x, y }) {
  return (
    <g opacity="0.3">
      <rect x={x} y={y} width="8" height="6" rx="0.8" fill={C.navy}
...
function GuardBooth({ x, y }) {
  return (
    <g opacity="0.5">
      <rect x={x} y={y} width="8" height="8" rx="1" fill={C.navyMid}
      ...
      {/* Warm glow */}
      <circle cx={x+2.5} cy={y+2.2} r="3" fill={C.goldLight} opacity="0.04">
...
function SiteBase({ children, dim = false, solar = false, heat = false }) {
  return (
    <g opacity={dim ? 0.3 : 1}>
      ...
      <g opacity="0.06">
        <path d="M199,142 L192,160 L206,160 Z" fill={C.goldLight} />
        <path d="M258,155 L252,170 L264,170 Z" fill={C.goldLight} />
      </g>
      ...
      <g opacity="0.3">
        ...
        <path d="M137,94 L145,96 L137,98" fill={C.gold} opacity="0.25">
          <animate attributeName="d"
...
function CompassRose({ x, y }) {
  return (
    <g opacity="0.35">
      <circle cx={x} cy={y} r="7" fill={C.navy} stroke={C.gold} strokeWidth="0.4" opacity="0.8" />
      ...
      {[["N",x,y-8.5],["S",x,y+10],["E",x+9,y+1.5],["W",x-9,y+1.5]].map(([l,lx,ly]) => (
        <text key={l} x={lx} y={ly} textAnchor="middle" fill={l==="N" ? C.gold : C.midGray}
    ...
    <>
      ...
      <SiteBase>
        ...
        <g opacity="0.04" transform="rotate(-45 200 180)">
          <text x="100" y="190" fill={C.gold} fontSize="18" fontFamily="Calibri, sans-serif"
        ...
        {[
          [144,150,52,26,C.warmOrange,0.08],[200,142,58,34,C.gold,0.06],[262,155,34,24,C.warmOrangeLight,0.07]
        ...
        {[
          ...
          <g key={i}>
            <rect x={x-6} y={y-5} width="12" height="9" rx="2.5" fill={C.gold} opacity="0.13" />
        ...
        <g filter="url(#shadow)">
          ...
          <circle cx="108" cy="190" r="3" fill={C.navy} stroke={C.gold} strokeWidth="0.6" />
          <circle cx="108" cy="190" r="1.5" fill={C.goldLight} opacity="0.35" />
          {/* Laser line to buildings */}
          <line x1="108" y1="190" x2="200" y2="170" stroke={C.gold} strokeWidth="0.3" opacity="0.18"
            strokeDasharray="2,3">
            <animate attributeName="opacity" values="0.1;0.3;0.1" dur="2s" repeatCount="indefinite" />
          </line>
          <line x1="108" y1="190" x2="175" y2="155" stroke={C.goldLight} strokeWidth="0.2" opacity="0.12"
            strokeDasharray="2,4" />
          <line x1="108" y1="190" x2="262" y2="160" stroke={C.goldLight} strokeWidth="0.2" opacity="0.1"
            strokeDasharray="2,4" />
          {/* Stick figure person with hardhat */}
          <circle cx="118" cy="202" r="2" fill="rgba(255,255,255,0.2)" />
          <rect cx="117" cy="200" width="2" height="0.8" rx="0.3" fill={C.gold} opacity="0.3" x="117" y="199.5" />
        ...
        <g opacity="0.38" filter="url(#shadow)">
          ...
          <circle cx="312" cy="203" r="2" fill={C.navy} stroke="rgba(255,255,255,0.18)" strokeWidth="0.4" />
          <g>
            <animateTransform attributeName="transform" type="rotate"
        ...
        <g opacity="0.32">
          ...
          {[0,1,2].map((j) => (
            <path key={j} d={`M${330+j*3},${210-j*2} Q${332+j*3},${208-j*2} ${334+j*3},${210-j*2}`}
              fill="none" stroke={C.goldLight} strokeWidth="0.3" opacity="0.14">
      ...
      {/* Existing PV */}
      <g>
        <rect x="38" y="172" width="38" height="24" rx="2" fill={C.gold} opacity="0.18"
      ...
      <g opacity="0.55">
        <rect x="334" y="260" width="28" height="36" rx="3" fill={C.navy}
    ...
    <>
      ...
      <SiteBase solar>
        ...
        {[[200,148,32,"S"],[262,160,20,"W"]].map(([fx,fy,fw,orient],i) => (
          <g key={`fass${i}`}>
            <rect x={fx} y={fy} width={fw} height={i===0?26:18} rx="0.5"
              fill={C.gold} opacity="0.09" stroke={C.goldLight} strokeWidth="0.3" />
            {Array.from({ length: Math.floor(fw/4) }, (_,j) => (
              <line key={j} x1={fx+2+j*4} y1={fy+1} x2={fx+2+j*4} y2={fy+(i===0?25:17)}
                stroke={C.goldLight} strokeWidth="0.15" opacity="0.28" />
            ))}
        ...
        {[[144,150,"SANIERUNG"],[200,142,"SANIERUNG"]].map(([bx,by,label],i) => (
          <g key={`ds${i}`} opacity="0.22">
            <rect x={bx+2} y={by-1} width={label.length*2.8+4} height="5" rx="0.8"
              fill={C.warmOrange} opacity="0.2" />
            <text x={bx+4} y={by+3} fill={C.warmOrangeLight}
        ...
        <g>
          ...
          {/* Gutter channel */}
          <line x1="108" y1="207.5" x2="160" y2="207.5" stroke={C.goldDim} strokeWidth="0.5" opacity="0.3" />
          {Array.from({ length: 7 }, (_,i) => (
            <line key={i} x1={112+i*6.5} y1="199.5" x2={112+i*6.5} y2="206"
              stroke={C.goldLight} strokeWidth="0.2" opacity="0.5" />
          ))}
          {/* Electrical junction box */}
          <rect x="156" y="201" width="4" height="3" rx="0.5" fill={C.navy}
            stroke={C.goldLight} strokeWidth="0.3" opacity="0.6" />
          <circle cx="158" cy="202.5" r="0.5" fill={C.greenLight} opacity="0.5">
            <animate attributeName="opacity" values="0.3;0.8;0.3" dur="1.8s" repeatCount="indefinite" />
          </circle>
          {/* Panel tilt indicator */}
          <path d="M108,199 L105,202" fill="none" stroke={C.goldLight} strokeWidth="0.35" opacity="0.32" />
          <text x="102" y="204" fill={C.goldLight} fontSize="2.5" opacity="0.32">15°</text>
        ...
        <g>
          ...
          <line x1="265" y1="200.5" x2="312" y2="200.5" stroke={C.goldDim} strokeWidth="0.5" opacity="0.28" />
          {Array.from({ length: 6 }, (_,i) => (
            <line key={i} x1={269+i*6.5} y1="192.5" x2={269+i*6.5} y2="199"
              stroke={C.goldLight} strokeWidth="0.2" opacity="0.5" />
          ))}
          <rect x="310" y="194" width="4" height="3" rx="0.5" fill={C.navy}
            stroke={C.goldLight} strokeWidth="0.3" opacity="0.6" />
        ...
        {[[196,172],[256,178],[146,200]].map(([x,y],i) => (
          <g key={i}>
            <rect x={x} y={y} width="5" height="4" rx="0.5" fill={C.navy}
              stroke={C.goldLight} strokeWidth="0.4" />
            ...
            <ellipse cx={x+4} cy={y+3} rx="0.6" ry="0.3" fill={C.goldLight} opacity="0.2">
        ...
        {[[182,144],[240,136],[175,176]].map(([cx,cy],i) => (
          <g key={`crew${i}`} opacity="0.15">
            ...
            {/* Hardhat */}
            <rect x={cx-1.5} y={cy-7} width="3" height="1" rx="0.5" fill={C.gold} opacity="0.4" />
        ...
        <g>
          {/* Light scatter */}
          <circle cx="358" cy="72" r="22" fill={C.gold} opacity="0.04">
          ...
          <circle cx="358" cy="72" r="10" fill={C.goldLight} opacity="0.16" />
          <circle cx="358" cy="72" r="5.5" fill={C.goldLight} opacity="0.38" />
          {/* Lens flare circles */}
          <circle cx="340" cy="82" r="2.5" fill={C.goldLight} opacity="0.04" />
          <circle cx="328" cy="90" r="4" fill={C.goldLight} opacity="0.025" />
          <circle cx="318" cy="96" r="1.5" fill={C.goldLight} opacity="0.035" />
          {/* Sun angle arc */}
          <path d="M358,72 L340,110" fill="none" stroke={C.goldLight} strokeWidth="0.3" opacity="0.1"
            strokeDasharray="3,4" />
          <path d="M350,82 Q346,88 348,92" fill="none" stroke={C.goldLight} strokeWidth="0.4" opacity="0.12" />
          <text x="342" y="94" fill={C.goldLight} fontSize="3" opacity="0.14">32°</text>
          ...
          {[[175,125],[225,118],[280,130],[135,135]].map(([tx,ty],i) => (
            <line key={i} x1={348-i*3} y1={78+i*2} x2={tx} y2={ty}
              stroke={C.goldLight} strokeWidth="0.3" opacity="0.07" strokeDasharray="5,10">
      ...
      {/* Existing PV dimmed */}
      <g opacity="0.4">
        <rect x="38" y="182" width="24" height="16" rx="1.5" fill={C.gold} opacity="0.2"
          stroke={C.gold} strokeWidth="0.5" />
        {Array.from({ length: 3 }, (_,i) => (
...
function SpeicherVisual() {
  return (
    <>
      ...
      <g filter="url(#shadow)">
        {[0,1,2,3,4].map((i) => (
          <g key={i}>
            ...
            <rect x={123+i*30} y="228" width="30" height="22" rx="4" fill={C.greenLight} opacity="0">
            ...
            <rect x={126+i*30} y="232" width="26" height="14" rx="2"
              fill={C.green} opacity="0.52" stroke={C.greenLight} strokeWidth="0.7" />
            ...
            {[0,1,2].map((j) => (
              <g key={j}>
                ...
                <circle cx={131.25+i*30+j*7} cy="239" r="1.5" fill="none"
                  stroke={C.greenLight} strokeWidth="0.3" opacity="0.28">
                  <animateTransform attributeName="transform" type="rotate"
            ...
            <text x={135+i*30} y="246.8" textAnchor="middle" fill={C.greenLight}
      ...
      <g filter="url(#glow)">
        <rect x="168" y="152" width="64" height="44" rx="5" fill={C.navy}
        ...
        <circle cx="220" cy="165" r="4" fill="none" stroke={C.greenLight}
          strokeWidth="4" strokeDasharray="16 9" opacity="0.3"
          transform="rotate(-90 220 165)" />
        <circle cx="220" cy="165" r="4" fill="none" stroke={C.gold}
          strokeWidth="4" strokeDasharray="9 16" opacity="0.25"
          transform="rotate(-90 220 165)" />
        {/* Efficiency gauge */}
        <rect x="175" y="180" width="20" height="3" rx="1" fill="rgba(0,0,0,0.2)" />
        <rect x="175" y="180" width="18" height="3" rx="1" fill={C.greenLight} opacity="0.28" />
        <text x="198" y="182.5" fill={C.greenLight} fontSize="2.5"
        ...
        <text x="200" y="191" textAnchor="middle" fill={C.goldLight}
          fontSize="9" fontFamily="Calibri, sans-serif" fontWeight="700">EMS</text>
      </g>

      {/* Control room window with screens */}
      <g opacity="0.35">
        <rect x="120" y="168" width="14" height="10" rx="1" fill={C.navy}
          stroke={C.goldLight} strokeWidth="0.4" />
      ...
      <g opacity="0.32">
        <path d="M120,238 L115,240 L120,242" fill="none" stroke={C.greenLight} strokeWidth="0.7" opacity="0.45">
          <animate attributeName="opacity" values="0.2;0.6;0.2" dur="2s" repeatCount="indefinite" />
        </path>
        <text x="108" y="241.5" textAnchor="middle" fill={C.greenLight}
          fontSize="3" fontFamily="Calibri, sans-serif">LADE</text>
        <path d="M290,238 L295,240 L290,242" fill="none" stroke={C.goldLight} strokeWidth="0.7" opacity="0.45">
...
function WaermeVisual() {
  ...
  return (
    <>
      ...
      <g opacity="0.3">
        <rect x="165" y="213" width="15" height="5" rx="1.5" fill={C.navy}
      ...
      {[[155,170],[218,165],[275,163]].map(([x,y],i) => (
        <g key={`ti${i}`} opacity="0.3">
          <rect x={x} y={y} width="8" height="10" rx="3" fill={C.navy}
      ...
      {[[210,142],[264,155]].map(([x,y],i) => (
        <g key={`ev${i}`} opacity="0.25">
          <rect x={x} y={y-3} width="6" height="3" rx="0.5" fill={C.navyMid}
...
function LadeVisual() {
  return (
    <>
      ...
      <g opacity="0.22">
        <rect x="135" y="200" width="68" height="7" rx="3" fill={C.navy}
          stroke={C.greenLight} strokeWidth="0.4" />
        <text x="169" y="205.5" textAnchor="middle" fill={C.greenLight}
          fontSize="4" fontFamily="Calibri, sans-serif" fontWeight="700" letterSpacing="1.5">ELEKTRIFIZIERUNG</text>
      </g>

      {/* Traffic flow arrows */}
      <g opacity="0.15">
        <path d="M88,222 L100,218" fill="none" stroke={C.greenLight} strokeWidth="0.6"
          markerEnd="url(#arrGr)" />
        <path d="M100,250 L88,254" fill="none" stroke={C.greenLight} strokeWidth="0.6"
          markerEnd="url(#arrGr)" />
        <path d="M310,218 L322,222" fill="none" stroke={C.greenLight} strokeWidth="0.6"
          markerEnd="url(#arrGr)" />
      </g>

      {/* Load management bar */}
      <g opacity="0.42">
        <rect x="175" y="192" width="50" height="5" rx="2" fill={C.navy}
          stroke={C.greenLight} strokeWidth="0.4" />
        <rect x="176" y="193" width="32" height="3" rx="1.5" fill={C.greenLight} opacity="0.28">
        ...
        {Array.from({ length: 10 }, (_,i) => {
          ...
          return (
            <g key={i}>
              ...
              {/* Status LED */}
              <circle cx={wx+3.5} cy={wy+8.5} r="0.8" fill={charging?C.greenLight:C.gold}>
              ...
              {charging && (
                <line x1={wx+3.5} y1={wy+9.5} x2={wx+3.5} y2={wy+13}
                  stroke={C.greenLight} strokeWidth="0.5" opacity="0.25">
              ...
              {charging && (
                <rect x={wx+5.5} y={wy+10-(3+i%4)} width="1" height={3+i%4} rx="0.3"
                  fill={C.greenLight} opacity="0.32" />
              )}
            </g>
          );
        })}
      ...
      <g>
        ...
        {[0,1,2,3].map((i) => (
          <g key={i}>
            ...
            <path d={`M${271+i*12},220 L${272.5+i*12},222.5 L${270+i*12},223 L${272.5+i*12},226`}
              fill="none" stroke={C.goldLight} strokeWidth="0.7" opacity="0.62">
              <animate attributeName="opacity" values="0.3;0.9;0.3"
                dur={`${0.7+i*0.15}s`} repeatCount="indefinite" />
            </path>
            {/* RFID blink */}
            <circle cx={273+i*12} cy={224} r="0.8" fill={C.gold} opacity="0.2">
            ...
            <line x1={271+i*12} y1="226" x2={271+i*12} y2="232"
              stroke={C.goldLight} strokeWidth="1" opacity="0.18">
              <animate attributeName="opacity" values="0.1;0.35;0.1"
        ...
        <g opacity="0.28">
          <path d="M262,236 L258,234 L258,238 Z" fill={C.greenLight} opacity="0.45">
            <animate attributeName="opacity" values="0.2;0.6;0.2" dur="2s" repeatCount="indefinite" />
          </path>
          <path d="M258,236 L262,234 L262,238 Z" fill={C.gold} opacity="0.35">
            <animate attributeName="opacity" values="0.2;0.6;0.2" dur="2s" repeatCount="indefinite"
              begin="1s" />
          </path>
          <text x="248" y="234" fill={C.greenLight} fontSize="2.5"
            fontFamily="Calibri, sans-serif">V2G</text>
          <text x="248" y="239" fill={C.midGray} fontSize="2"
            fontFamily="Calibri, sans-serif">Grid→Veh</text>
          <text x="248" y="243.5" fill={C.midGray} fontSize="2"
      ...
      <g>
        ...
        {[0,1,2,3,4].map((i) => (
          <g key={i}>
            ...
            {/* kW display */}
            <text x={147+i*25} y="273" textAnchor="middle" fill={C.greenLight}
              fontSize="3" fontFamily="Calibri, sans-serif" fontWeight="700">{150+i*50}</text>
            <text x={147+i*25} y="277" textAnchor="middle" fill={C.midGray}
              fontSize="2.5" fontFamily="Calibri, sans-serif">kW</text>
            {/* % charge */}
            <text x={147+i*25} y="281" textAnchor="middle" fill={C.greenLight}
...
function BESSVisual() {
  return (
    <>
      ...
      <g>
        ...
        <g>
          ...
          <path d="M82,120 L85,116 L88,120 L86,120 L89,116" fill="none"
            stroke={C.goldLight} strokeWidth="0.4" opacity="0.2" />
          {/* Insulators */}
          {[73,85,97].map((ix) => (
            <g key={ix}>
        ...
        <g opacity="0.38">
          <rect x="22" y="82" width="28" height="10" rx="2" fill={C.navy}
            stroke={C.greenLight} strokeWidth="0.4" />
        ...
        <text x="55" y="90" fill={C.midGray} fontSize="6"
          fontFamily="Calibri, sans-serif" fontWeight="700">110 kV</text>
      </g>

      {/* Transformer + switchgear */}
      <g filter="url(#shadow)">
        <rect x="108" y="158" width="28" height="22" rx="2.5" fill={C.navy}
          stroke={C.gold} strokeWidth="1.2" />
        {/* Humming animation */}
        <rect x="107" y="157" width="30" height="24" rx="3" fill="none"
          stroke={C.goldLight} strokeWidth="0.3" opacity="0">
      ...
      <g>
        <rect x="122" y="184" width="16" height="9" rx="2" fill={C.navy}
      ...
      <g>
        ...
        <g opacity="0.3">
          ...
          {/* Sweep arc */}
          <path d="M287,144 L295,138 L295,150 Z" fill={C.goldLight} opacity="0">
        ...
        <g opacity="0.2">
          <path d="M148,152 L152,136 L160,136 L158,152" fill={C.navyMid}
            stroke="rgba(255,255,255,0.06)" strokeWidth="0.4" />
          <ellipse cx="155" cy="136" rx="4" ry="1.5" fill={C.navyMid}
            stroke="rgba(255,255,255,0.05)" strokeWidth="0.3" />
          {/* Cooling water pipes */}
          <line x1="152" y1="152" x2="150" y2="160" stroke={C.coolBlue}
            strokeWidth="0.5" opacity="0.3" />
          <line x1="158" y1="152" x2="160" y2="160" stroke={C.coolBlue}
            strokeWidth="0.5" opacity="0.3" />
        </g>
          ...
          [0,1,2,3,4,5].map((col) => {
            ...
            return (
              <g key={`${row}-${col}`}>
                ...
                <circle cx={x+17} cy={y+3.5} r="1" fill={C.greenLight} opacity="0.42">
        ...
        <g opacity="0.22">
          <rect x="150" y="134" width="24" height="6" rx="2" fill={C.navy}
            stroke={C.gold} strokeWidth="0.3" />
          <text x="162" y="138.5" textAnchor="middle" fill={C.goldLight}
            fontSize="3" fontFamily="Calibri, sans-serif" fontWeight="700">ARBITRAGE</text>
        </g>
        <g opacity="0.2">
          <rect x="246" y="134" width="16" height="6" rx="2" fill={C.navy}
            stroke={C.greenLight} strokeWidth="0.3" />
          <text x="254" y="138.5" textAnchor="middle" fill={C.greenLight}
    ...
    <>
      ...
      <SiteBase solar heat>
        ...
        <g opacity="0.055" transform="rotate(-30 200 190)">
          <text x="100" y="210" fill={C.gold} fontSize="24" fontFamily="Calibri, sans-serif"
        ...
        {Array.from({ length: 12 }, (_,i) => {
          ...
          return (
            <g key={`sp${i}`}>
              <circle cx={sx} cy={sy} r="1" fill={C.goldLight} opacity="0">
                <animate attributeName="opacity"
              ...
              <line x1={sx-1.5} y1={sy} x2={sx+1.5} y2={sy} stroke={C.goldLight} strokeWidth="0.3" opacity="0">
                <animate attributeName="opacity" values="0;0;0.35;0"
                  dur={`${4+i*0.5}s`} repeatCount="indefinite" begin={`${i*0.4}s`} />
              </line>
              <line x1={sx} y1={sy-1.5} x2={sx} y2={sy+1.5} stroke={C.goldLight} strokeWidth="0.3" opacity="0">
                <animate attributeName="opacity" values="0;0;0.35;0"
                  dur={`${4+i*0.5}s`} repeatCount="indefinite" begin={`${i*0.4}s`} />
              </line>
            </g>
        ...
        <g>
          ...
          <rect x="108" y="206" width="52" height="2" fill={C.goldDim} opacity="0.42" />
          {[111,126,141,157].map((xp) => (
        ...
        <g>
          ...
          <rect x="265" y="199" width="47" height="2" fill={C.goldDim} opacity="0.42" />
          {[268,282,296,310].map((xp) => (
            ...
            return (
              <g key={i}>
                <rect x={bx} y={by} width="14" height="10" rx="1.5"
                  fill={C.green} opacity="0.47" stroke={C.greenLight} strokeWidth="0.5" />
                ...
                <rect x={bx+10} y={by+10-barH} width="2.5" height={barH} rx="0.5"
                  fill={C.greenLight} opacity="0.62" />
        ...
        {["ghp1","ghp2","ghp3"].map((id,i) => (
          <g key={id}>
            <use href={`#${id}`} fill="none" stroke={C.warmOrange} strokeWidth="3"
        ...
        {/* WP unit compact */}
        <g>
          <rect x="195" y="166" width="12" height="10" rx="2" fill={C.navy}
            stroke={C.warmOrange} strokeWidth="0.6" />
      ...
      {/* EMS central hub */}
      <g filter="url(#glow)">
        <rect x="180" y="130" width="40" height="22" rx="5" fill={C.navy}
          stroke={C.gold} strokeWidth="1.2" />
        ...
        {Array.from({ length: 6 }, (_,i) => {
          ...
          return (
            <rect key={i} x={186+i*5} y={146-bh} width="3" height={bh}
              fill={i<3?C.gold:C.greenLight} opacity="0.52" rx="0.3">
      ...
      {[
        ["gf_pv",C.goldLight,"PV→EMS",2,2,true],
        ["gf_bess",C.greenLight,"EMS→BESS",3,1.8,true],
      ...
      {/* Flow label badges */}
      <g opacity="0.4">
        <rect x="225" y="142" width="20" height="5" rx="2" fill={C.navy} stroke={C.gold} strokeWidth="0.3" />
        <text x="235" y="145.8" textAnchor="middle" fill={C.goldLight}
          fontSize="2.5" fontFamily="Calibri, sans-serif">PV→EMS</text>
        <rect x="165" y="195" width="22" height="5" rx="2" fill={C.navy}
          stroke={C.greenLight} strokeWidth="0.3" />
        <text x="176" y="198.8" textAnchor="middle" fill={C.greenLight}
          fontSize="2.5" fontFamily="Calibri, sans-serif">EMS→BESS</text>
        <rect x="100" y="125" width="22" height="5" rx="2" fill={C.navy} stroke={C.gold} strokeWidth="0.3" />
        <text x="111" y="128.8" textAnchor="middle" fill={C.goldLight}
      ...
      <g opacity="0.62">
        ...
        <text x="42" y="102" fill={C.midGray} fontSize="4.5"
          fontFamily="Calibri, sans-serif" fontWeight="700">110 kV</text>
      </g>
      ...
      <g>
            ...
            return (
              <g key={`e${row}-${col}`}>
                ...
                <rect x={cx+11.5} y={cy+10-barH} width="2" height={barH} rx="0.5"
                  fill={C.greenLight} opacity="0.57">
        ...
        <use href="#gf_rev" fill="none" stroke={C.gold} strokeWidth="0.6" opacity="0.06" />
        ...
        <g opacity="0.55">
          <rect x="30" y="244" width="58" height="9" rx="2" fill={C.navy}
            stroke={C.gold} strokeWidth="0.4" />
          <text x="44" y="249" fill={C.goldLight} fontSize="3.5"
            fontFamily="Calibri, sans-serif" fontWeight="700">€</text>
          <rect x="50" y="245" width="35" height="7" rx="1" fill="rgba(0,0,0,0.2)" />
          <rect x="50" y="245" width="0" height="7" rx="1" fill={C.gold} opacity="0.15">
      ...
      <g>
        {/* Outer glow */}
        <circle cx="355" cy="80" r="24" fill={C.gold} opacity="0.04">
          <animate attributeName="r" values="20;28;20" dur="4s" repeatCount="indefinite" />
          <animate attributeName="opacity" values="0.03;0.07;0.03" dur="4s" repeatCount="indefinite" />
        </circle>
        <circle cx="355" cy="80" r="14" fill={C.gold} opacity="0.07" />
        <circle cx="355" cy="80" r="8" fill={C.goldLight} opacity="0.18" />
        <circle cx="355" cy="80" r="4.5" fill={C.goldLight} opacity="0.38" />
        {/* Lens flares */}
        <circle cx="335" cy="93" r="3" fill={C.goldLight} opacity="0.045" />
        <circle cx="320" cy="103" r="5" fill={C.goldLight} opacity="0.025" />
        {/* Rays */}
        {Array.from({ length: 14 }, (_,i) => {
      ...
      <g>
        ...
        <rect x="326" y="224" width="62" height="1.5" rx="0.5" fill={C.greenLight} opacity="0.12">
      ...
      {/* Energy flow legend */}
      <g opacity="0.62">
        <rect x="12" y="260" width="65" height="42" rx="4" fill={C.navy} opacity="0.87"
...
function SvgAutarkieRing({ cx, cy, score, size = 36 }) {
  ...
  return (
    <g>
      <circle cx={cx} cy={cy} r={size / 2 + 4} fill={C.navy} opacity="0.87" />
      <circle cx={cx} cy={cy} r={size / 2 + 4} fill="none" stroke={C.gold} strokeWidth="0.4" opacity="0.16" />
